        ...
        return this.each(function() {
            ...
            $parent.hover(function(event) {
                ...
                if(shouldHover()) {
                    ...
                    hoverDelayParent = window.setTimeout(function() {
                        if(settings.instantlyCloseOthers === true) {
                            $allDropdowns.removeClass('open');
                        }
                        $parent.addClass('open');
                    }, settings.hoverDelayTime);
                }
            }, function() {
                if(shouldHover()) {
                    window.clearTimeout(hoverDelayParent);
            ...
            $this.hover(function() {
                window.clearTimeout(timeout);
                if(shouldHover()) {
                    hoverDelayGroup = window.setTimeout(function() {
                        if(settings.instantlyCloseOthers === true) {
                            $allDropdowns.removeClass('open');
                        }
                        $parent.addClass('open');
                ...
                if(shouldHover()) {
                    window.clearTimeout(hoverDelayGroup);
                }
            });
